...
export default function AdminDashboardPage() {
  ...
  const cards = [
    { label: 'イベント数', value: stats.events, href: '/admin/events', color: 'bg-blue-500' },
    { label: 'グッズ数', value: stats.goods, href: '/admin/goods', color: 'bg-green-500' },
    { label: 'アクティブユーザー数', value: stats.activeUsers, href: '#', color: 'bg-purple-500' },
  ]
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <h2 className="text-lg font-bold mb-2">イベント管理</h2>
          <p className="text-gray-500 text-sm">イベントの作成・編集・有効/無効の切り替え</p>
        </a>
        <a
          href="/admin/goods"
          className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow border-l-4 border-green-500"
        >
          <h2 className="text-lg font-bold mb-2">グッズ管理</h2>
          <p className="text-gray-500 text-sm">グッズの作成・編集・一括登録・画像アップロード</p>
        </a>
      </div>
    </div>
  )
